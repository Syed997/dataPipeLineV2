...
def get_config():
    return {
        ...
        'TOPIC_PATTERN': os.environ.get("TOPIC_PATTERN", "test-.*"),
        ...
        # 'CSV_EXPORT_LIMIT': int(os.getenv('CSV_EXPORT_LIMIT', 1000000)) if os.getenv('CSV_EXPORT_LIMIT') else None,
